...
![Ascii Table](images/day08_62303.png)  
...
你也可以發現霍夫曼是透過改善編碼的方式來達到壓縮資料的目的，採取的作法是一個個字詞單一去處理，直到後來已經慢慢被[算術編碼](<https://zh.wikipedia.org/wiki/%E7%AE%97%E6%9C%AF%E7%BC%96%E7%A0%81>)所取代， _算術編碼是直接把整個輸入的訊息編碼為一個數_ ，有興趣實做的話可以參考[這裡](<https://par.cse.nsysu.edu.tw/~homework/algo01/8934609/index.html>)。
